...
## Artwork Deep Learning Recommender
...
## Artwork Content-based Recommender

We develop a [*content-based*](https://towardsdatascience.com/how-to-build-from-scratch-a-content-based-movie-recommender-with-natural-language-processing-25ad400eb243) approach, which is a standard in the literature. This approach only use semantic information to generate the recommendations. We use this approach as a baseline in order to analize how better is the performance of the deep learning approach
